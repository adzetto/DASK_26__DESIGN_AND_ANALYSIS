...
Her kule: $30\!\times\!16\,\mathrm{cm}$ plan, $7\!\times\!3$ kolon gridi; zemin kat $9\,\mathrm{cm}$, üst 24~kat $6\,\mathrm{cm}$; $H\!=\!153\,\mathrm{cm}$.
Kuleler arası açıklık $8\,\mathrm{cm}$.
İç açıklıklarda ($3{,}7\,\mathrm{cm}$) zemin--13.~kat ve son 2~katta X-çapraz elemanlar uygulanmıştır.
Dış açıklıklarda $XZ$ ve $YZ$ çaprazlar alt 4~katta her katta, üst katlarda 3~katlık zikzak düzeniyle yerleştirilmiştir.
Köprüler 6., 12., 18.\ ve 25.~katta olup her biri 24~elemandan oluşur.

\noindent\textbf{Analiz ve sonuçlar.}
Model \textsc{OpenSees}~\cite{opensees} ile 1108~düğüm, 2794~eleman (2170~çerçeve + 624~kafes) olarak oluşturulmuştur.
Balsa: $E\!=\!350\,\mathrm{kN/cm^2}$, $\rho\!=\!160\,\mathrm{kg/m^3}$; çıta: $A\!=\!0.36\,\mathrm{cm^2}$, $I\!=\!0.0108\,\mathrm{cm^4}$.
Yapısal ağırlık $W\!=\!1.168\,\mathrm{kg}$ ($<2.000\,\mathrm{kg}$).
Modal periyotlar: $T_1\!=\!0.115$~s (plato), $T_2\!=\!0.079$~s, $T_3\!=\!0.054$~s; $T_1$ plato bölgesinde, $T_2$ ve $T_3$ artan bölgededir.
Eksantrisite $e_x/L_x\!=\!0{,}000$, $e_y/L_y\!=\!0{,}000$ (tam simetri); zemin katta $\eta_{bi}\!=\!1.69 < 2.0$ ile A1a kontrolü sağlanmıştır~\cite{tbdy2018}.
...
% n-1. kat - köprü yok
% Kirişler (üst ve alt)
\draw[line width=0.5pt] (0.3,0) -- (15.7,0);
\draw[line width=0.5pt] (24.3,0) -- (39.7,0);
\draw[line width=0.5pt] (0.3,\kh) -- (15.7,\kh);
\draw[line width=0.5pt] (24.3,\kh) -- (39.7,\kh);
% Kolonlar
\foreach \y in {0.3,8.0,15.7,24.3,32.0,39.7} {
    \draw[fill=white, draw=black, line width=0.4pt] (\y-0.4,0) rectangle (\y+0.4,\kh);
}
% X-brace çaprazlar
\draw[line width=0.3pt, gray] (0.3,0) -- (8.0,\kh);
\draw[line width=0.3pt, gray] (8.0,0) -- (0.3,\kh);
\draw[line width=0.3pt, gray] (8.0,0) -- (15.7,\kh);
\draw[line width=0.3pt, gray] (15.7,0) -- (8.0,\kh);
\draw[line width=0.3pt, gray] (24.3,0) -- (32.0,\kh);
\draw[line width=0.3pt, gray] (32.0,0) -- (24.3,\kh);
\draw[line width=0.3pt, gray] (32.0,0) -- (39.7,\kh);
\draw[line width=0.3pt, gray] (39.7,0) -- (32.0,\kh);
...
\draw[line width=0.3pt, gray] (32.0,0) -- (39.7,\kh);
\draw[line width=0.3pt, gray] (39.7,0) -- (32.0,\kh);
% KÖPRÜ (y=15.7 ile y=24.3 arası, 8.6cm açıklık)
\draw[line width=0.6pt] (15.7,2) -- (24.3,2);
\draw[line width=0.6pt] (15.7,4) -- (24.3,4);
\draw[line width=0.3pt, gray] (15.7,2) -- (24.3,4);
\draw[line width=0.3pt, gray] (24.3,2) -- (15.7,4);
...
\draw[fill=black] (15.7,3) circle (0.4);
\draw[fill=black] (24.3,3) circle (0.4);
\end{scope}
...
% Döşeme çaprazları (Kule 1) - köşe ve merkez panel
% Köşe sol
...
% Etiketler
\node[font=\small] at (8,4) {Kule 1};
\node[font=\small] at (8,28) {Kule 2};
...
\node[font=\tiny, rotate=90] at (35,20) {8.6 cm};
\draw[<->, line width=0.3pt] (11.3,43) -- (18.7,43);
\node[font=\tiny] at (15,45) {7.4 cm};
...
\caption{V10 modeli kolon yerleşimi ve köprü bağlantısı: (a)~YZ kesiti ($n{-}1$, $n$, $n{+}1$ katları), (b)~köprü katı planı. $7 \times 3$ kolon gridi, köprü açıklığı $8{,}6$~cm. Temsilî çizim için DASK 2026 kodları~\cite{github_repo} kullanılmıştır.}
\label{fig:plan}
\end{figure}
