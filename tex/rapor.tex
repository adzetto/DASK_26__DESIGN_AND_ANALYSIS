...
\noindent\textbf{Saha koşulları ve deprem tehlikesi.}
Proje sahası İstanbul Finans Merkezi ($41.00^\circ$\,K, $29.11^\circ$\,D) Kuzey Anadolu Fayı'na yakın olup yüksek sismik tehlike altındadır.
AFAD~\cite{afad2024} verileri: $S_S\!=\!0.877$, $S_1\!=\!0.243$; ZD zemin ($F_S\!=\!1.149$, $F_1\!=\!2.114$).
Tasarım parametreleri: $S_{DS}\!=\!1.008$\,g, $S_{D1}\!=\!0.514$\,g; köşe periyotları $T_A\!=\!0.102$~s, $T_B\!=\!0.510$~s.
Yapı $DTS\!=\!1$, $BYS\!=\!1$, $I\!=\!1.0$ kapsamındadır~\cite{tbdy2018}.
TS~EN~1991-1-4~\cite{tsen1991} rüzgar kesmesi $F_w\!\approx\!3.1$\,MN iken deprem taban kesmesi $V_t\!\approx\!6.6$\,MN olup sismik yükler belirleyicidir.

\noindent\textbf{Taşıyıcı sistem seçimi.}
Beş tasarım hedefi belirlenmiştir: (i)~yeterli yanal rijitlik, (ii)~düşük eksantrisite, (iii)~sünek davranış, (iv)~kesintisiz yük aktarımı, (v)~minimum ağırlık.
Moment çerçevesi sünek fakat rijitliği yetersiz; salt çaprazlı sistem rijit fakat gevrek.
Çerçeve--çapraz hibrit sistem her ikisinin avantajını birleştirir~\cite{nehrp2009}.
İkiz kule konfigürasyonu köprü bağlantıları ile yük paylaşımı ve global rijitlik artışı sağlar~\cite{patoliya2023, tambunan2024}.

\noindent\textbf{Sistem geometrisi.}
Model $40\!\times\!40\,\mathrm{cm}$ tabla üzerinde $6\!\times\!6\,\mathrm{mm}$ balsa çıtadan imal edilmiştir (Şekil~\ref{fig:sistem}).
Her kule: $30\!\times\!16\,\mathrm{cm}$ plan, $8\!\times\!4$ kolon gridi; zemin kat $9\,\mathrm{cm}$, üst 24~kat $6\,\mathrm{cm}$; $H\!=\!153\,\mathrm{cm}$.
Kuleler arası açıklık $8\,\mathrm{cm}$.
İç açıklıklarda ($3{,}4\,\mathrm{cm}$) zemin--2.\ köprü arasında (0--12.~kat) X-çapraz elemanlar uygulanmıştır.
Dış açıklıklarda $XZ$ ve $YZ$ çaprazlar 3~katlık zikzak düzeniyle yerleştirilmiştir.
Köprüler 6., 12., 18.\ ve 25.~katta olup her biri 24~elemandan oluşur.

\noindent\textbf{Analiz ve sonuçlar.}
Model \textsc{OpenSees}~\cite{opensees} ile 1680~düğüm, 3808~\texttt{elasticBeamColumn} elemanı olarak oluşturulmuştur.
Balsa: $E\!=\!170\,\mathrm{kN/cm^2}$, $\rho\!=\!160\,\mathrm{kg/m^3}$; çıta: $A\!=\!0.36\,\mathrm{cm^2}$, $I\!=\!0.0108\,\mathrm{cm^4}$.
Yapısal ağırlık $W\!=\!1.377\,\mathrm{kg}$ ($<2.000\,\mathrm{kg}$).
Modal periyotlar: $T_1\!=\!0.200$~s, $T_2\!=\!0.147$~s, $T_3\!=\!0.135$~s; üçü de plato bölgesindedir.
Göreli öteleme $\delta_i/h_i\!=\!0.00017 \ll 0.008$; eksantrisite $e_x/L_x\!=\!0.005$, $e_y/L_y\!=\!0.034$ ile kontroller sağlanmıştır~\cite{tbdy2018}.
...
\foreach \x in {0.3,3,11.3,15,18.7,27,29.7} {
  \draw[cyan!60!black, line width=0.3pt] (\x,0) -- (\x,153);
}
% --- Kirişler beam_x (yeşil): her kat ---
\draw[green!60!black, line width=0.15pt] (0.3,0) -- (29.7,0);
\draw[green!60!black, line width=0.15pt] (0.3,9) -- (29.7,9);
\foreach \f in {2,...,25} {
  \pgfmathsetmacro{\z}{9+(\f-1)*6}
  \draw[green!60!black, line width=0.15pt] (0.3,\z) -- (29.7,\z);
}
% --- Çapraz XZ: iç 3.7cm açıklıklar, X-cross kat 0--12 + son 2 kat ---
\foreach \za/\zb in {0/9,9/15,15/21,21/27,27/33,33/39,39/45,45/51,51/57,57/63,63/69,69/75,75/81,141/147,147/153} {
  \foreach \xa/\xb in {11.3/15,15/18.7} {
    \draw[magenta!80, line width=0.2pt] (\xa,\za)--(\xb,\zb);
    \draw[magenta!80, line width=0.2pt] (\xb,\za)--(\xa,\zb);
  }
}
% --- Çapraz XZ: 8cm açıklıklar (3-11, 19-27), ilk 4 kat tek, sonra 3'er katlık ---
...
% --- Ölçüler ---
\draw[<->,thin,black!60] (-3,0) -- node[left,font=\tiny,rotate=90,anchor=south]{$H\!=\!153$} (-3,153);
\draw[<->,thin,black!60] (0.3,-3.5) -- node[below,font=\tiny]{$30$} (29.7,-3.5);
\draw[<->,thin,black!40] (31.5,0) -- node[right,font=\tiny]{$9$} (31.5,9);
\draw[<->,thin,black!40] (31.5,9) -- node[right,font=\tiny]{$6$} (31.5,15);
% Alt başlık
\node[font=\footnotesize,anchor=north] at (15,-7) {(a) Ön görünüm ($XZ$)};
\end{scope}
...
% --- Kolonlar Kule 1 (cyan) ---
\foreach \y in {0.3,8,15.7} {
  \draw[cyan!60!black, line width=0.3pt] (\y,0) -- (\y,153);
}
% --- Kolonlar Kule 2 (cyan) ---
\foreach \y in {24.3,32,39.7} {
  \draw[cyan!60!black, line width=0.3pt] (\y,0) -- (\y,153);
}
% --- Kirişler beam_y (turuncu): her kat ---
\draw[orange!70!black, line width=0.15pt] (0.3,0)--(15.7,0);
\draw[orange!70!black, line width=0.15pt] (24.3,0)--(39.7,0);
\draw[orange!70!black, line width=0.15pt] (0.3,9)--(15.7,9);
\draw[orange!70!black, line width=0.15pt] (24.3,9)--(39.7,9);
\foreach \f in {2,...,25} {
  \pgfmathsetmacro{\z}{9+(\f-1)*6}
  \draw[orange!70!black, line width=0.15pt] (0.3,\z)--(15.7,\z);
  \draw[orange!70!black, line width=0.15pt] (24.3,\z)--(39.7,\z);
}
% --- Çapraz YZ (kırmızı): DAMALI, simetrik, alt/üst full ---
% FULL: alt (0→9) ve üst (135→153) — tüm kanatlar
\foreach \za/\zb in {0/9,135/153} {
  \foreach \ya/\yb in {0.3/8,8/15.7,24.3/32,32/39.7} {
    \draw[red!80, line width=0.25pt] (\ya,\za)--(\yb,\zb);
    \draw[red!80, line width=0.25pt] (\yb,\za)--(\ya,\zb);
  }
}
% Tek gruplar (1,3,5,7,9): T1 sağ (8→15.7) + T2 sol (24.3→32)
\foreach \za/\zb in {9/15,21/27,45/63,81/99,117/135} {
  \foreach \ya/\yb in {8/15.7,24.3/32} {
    \draw[red!80, line width=0.25pt] (\ya,\za)--(\yb,\zb);
    \draw[red!80, line width=0.25pt] (\yb,\za)--(\ya,\zb);
  }
}
% Çift gruplar (2,4,6,8): T1 sol (0.3→8) + T2 sağ (32→39.7)
\foreach \za/\zb in {15/21,27/45,63/81,99/117} {
  \foreach \ya/\yb in {0.3/8,32/39.7} {
    \draw[red!80, line width=0.25pt] (\ya,\za)--(\yb,\zb);
    \draw[red!80, line width=0.25pt] (\yb,\za)--(\ya,\zb);
  }
}
% --- Köprüler (turuncu): 6., 12., 18. kat ---
\foreach \za/\zb in {33/39,69/75,105/111} {
  % Kolon
  \draw[orange!70!black, line width=0.4pt] (20,\za)--(20,\zb);
  % Kirişler
  \draw[orange!70!black, line width=0.3pt] (15.7,\za)--(24.3,\za);
  \draw[orange!70!black, line width=0.3pt] (15.7,\zb)--(24.3,\zb);
  % Çapraz kafes
  \draw[orange!50, line width=0.2pt] (15.7,\za)--(20,\zb);
  \draw[orange!50, line width=0.2pt] (20,\za)--(15.7,\zb);
  \draw[orange!50, line width=0.2pt] (20,\za)--(24.3,\zb);
  \draw[orange!50, line width=0.2pt] (24.3,\za)--(20,\zb);
}
% --- Köprü 4 (çift kat, Z=141--153) ---
\draw[orange!70!black, line width=0.4pt] (20,141)--(20,153);
\draw[orange!70!black, line width=0.3pt] (15.7,141)--(24.3,141);
\draw[orange!70!black, line width=0.3pt] (15.7,147)--(24.3,147);
\draw[orange!70!black, line width=0.3pt] (15.7,153)--(24.3,153);
\draw[orange!50, line width=0.2pt] (15.7,141)--(20,147);
\draw[orange!50, line width=0.2pt] (20,141)--(15.7,147);
\draw[orange!50, line width=0.2pt] (20,141)--(24.3,147);
\draw[orange!50, line width=0.2pt] (24.3,141)--(20,147);
\draw[orange!50, line width=0.2pt] (15.7,147)--(20,153);
\draw[orange!50, line width=0.2pt] (20,147)--(15.7,153);
\draw[orange!50, line width=0.2pt] (20,147)--(24.3,153);
\draw[orange!50, line width=0.2pt] (24.3,147)--(20,153);
% Kule etiketleri
\node[font=\tiny,black!50] at (8,80) {Kule\,1};
\node[font=\tiny,black!50] at (32,80) {Kule\,2};
% Köprü etiketleri
\node[font=\tiny,black!60,anchor=west] at (24.8,36) {K.6};
\node[font=\tiny,black!60,anchor=west] at (24.8,72) {K.12};
\node[font=\tiny,black!60,anchor=west] at (24.8,108) {K.18};
\node[font=\tiny,black!60,anchor=west] at (24.8,147) {K.25};
% --- Ölçüler ---
\draw[<->,thin,black!60] (0.3,-3.5) -- node[below,font=\tiny]{$16$} (15.7,-3.5);
\draw[<->,thin,black!60] (15.7,-3.5) -- node[below,font=\tiny]{$8$} (24.3,-3.5);
\draw[<->,thin,black!60] (24.3,-3.5) -- node[below,font=\tiny]{$16$} (39.7,-3.5);
\draw[<->,thin,black!60] (-3,0) -- node[left,font=\tiny,rotate=90,anchor=south]{$153$} (-3,153);
% Alt başlık
\node[font=\footnotesize,anchor=north] at (20,-7) {(b) Yan görünüm ($YZ$)};
\end{scope}
\end{tikzpicture}%
}
\caption{V10 yapısal sistem: (a)~ön görünüm ($XZ$)---iç açıklıklarda X-çapraz (0--12.~kat), dış açıklıklarda 3~katlık zikzak; (b)~yan görünüm ($YZ$)---köprü bağlantıları ve 3~katlık zikzak çaprazlar. Renkler: \textcolor{cyan!60!black}{kolon}, \textcolor{green!60!black}{kiriş\,$X$}, \textcolor{orange!70!black}{kiriş\,$Y$\,/\,köprü}, \textcolor{magenta!80}{çapraz\,$XZ$}, \textcolor{red!80}{çapraz\,$YZ$}. Ölçüler cm.}
\label{fig:sistem}
\end{figure}
